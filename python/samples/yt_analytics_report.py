...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--start-date", default=one_week_ago, help="Start date, in YYYY-MM-DD format"
    )
    parser.add_argument(
        "--end-date", default=one_day_ago, help="End date, in YYYY-MM-DD format"
    )
