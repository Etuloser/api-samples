...
def update_video(youtube, args):
    ...
    videos_list_response = (
        youtube.videos().list(id=args.video_id, part="snippet").execute()
    )
    ...
    videos_update_response = (
        youtube.videos()
        .update(
            part="snippet", body=dict(snippet=videos_list_snippet, id=args.video_id)
        )
        .execute()
    )
    ...
    if videos_update_response["snippet"]["description"]:
        print(
            ("Description: " + videos_update_response["snippet"]["description"] + "\n")
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--video_id", help="ID of video to update.", required=True)
    parser.add_argument(
        "--tags",
