...
def insert_stream(youtube, options):
    insert_stream_response = (
        ...
        .insert(
            part="snippet,cdn",
            body=dict(
                snippet=dict(title=options.stream_title),
    ...
    print(
        "Stream '%s' with title '%s' was inserted."
...
if __name__ == "__main__":
    argparser.add_argument(
        "--broadcast-title", help="Broadcast title", default="New Broadcast"
    )
    argparser.add_argument(
        "--privacy-status", help="Broadcast privacy status", default="private"
    )
    argparser.add_argument(
        "--start-time", help="Scheduled start time", default="2014-01-30T00:00:00.000Z"
    )
    argparser.add_argument(
        "--end-time", help="Scheduled end time", default="2014-01-31T00:00:00.000Z"
    )
